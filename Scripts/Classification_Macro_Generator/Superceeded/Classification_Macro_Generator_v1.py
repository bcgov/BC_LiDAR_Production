...
def create_macro_file(directory):
    ...
    macro_content.extend([
        ...
        "FnScanClassifyGround(\"0\",2,\"2\",1,60.0,88.00,6.00,1.40,1,5.0,0,2.0,0,0,0)",
    ...
    macro_dir = os.path.join(directory, "Custom_Classification_Macro")
    os.makedirs(macro_dir, exist_ok=True)
    
    # Write to .mac file in the new folder
    macro_file_path = os.path.join(macro_dir, "Custom_Closeby_Classification.mac")
...
# Tkinter GUI setup
root = tk.Tk()
root.title("Classification Macro Generator_v1.2")
